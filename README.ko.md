...
- [노드와 파라미터 가이드](docs/parameter_guide.ko.md)
- [영문 Parameter Guide](docs/parameter_guide.md)
...
내부 workflow id: `OTBlueLineCleanup`
...
내부 workflow id: `OTLineAutoClose`
...
내부 workflow id: `OTRegionPaletteMap`
...
이 저장소는 public이므로 GitHub 인증 없이 clone할 수 있습니다.
...
`Blue Sketch Cleaner`는 전체 페이지에서도 line extraction preview 용도로
쓸 수 있습니다. 하지만 `Line Gap Closer`와 `Color Region Finder`는
